...
Blockly.Python['controls_if'] = function(block) {
  ...
  do {
    ...
    code += (n == 0 ? 'if ' : 'elif ' ) + conditionCode + ':\n' + branchCode;
     ...
     if_var = conditionCode;
     if_state = branchCode;
     statement.push(branchCode);
     
     // if일 경우
     if( n == 0) {
       if_condition.push({if_var: conditionCode, if_statement: branchCode});
     }
     
     // else일 경우
     if(n != 0) {
       if_condition[index].elif_var = conditionCode;
       if_condition[index].elif_statement = branchCode;
     }
    // conditions.push(conditionCode, branchCode);
  ...
  if (block.getInput('ELSE')) {
    branchCode = Blockly.Python.statementToCode(block, 'ELSE') ||
        "";
    code += 'else:\n' + branchCode;
     else_state = branchCode;
     statement.push(branchCode);
    // conditions.push(branchCode);
    // console.log(branchCode);
    if_condition[index].else_statement = branchCode;
  }
...
Blockly.Python['logic_compare'] = function(block) {
  ...
  ingredient_compare.push(argument0, argument1, operator);
  //console.log(ingredient_compare);
...
Blockly.Python['text'] = function(block) {
  ...
  //text.push(block.getFieldValue('TEXT'));
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Python['variables_set'] = function(block) {
  ...
  //argument0 = 변수값
   ...
   if(var_name == "isEmpty") {
       isEmpty = argument0;
   }else if(var_name == "isTurnOver") {
       isTurnOver = argument0;
   }else if(var_name == "state") {
       state = argument0;
   }else if(var_name == "ingredient") {
       ingredient = argument0;
   }
