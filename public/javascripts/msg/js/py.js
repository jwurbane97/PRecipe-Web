...
Blockly.Msg.CONTROLS_IF_ELSEIF_TOOLTIP = "\"if\" 블럭에 조건 검사를 추가합니다.";
Blockly.Msg.CONTROLS_IF_ELSE_TOOLTIP = "\"if\" 블럭의 마지막에, 모든 검사 결과가 거짓인 경우 실행할 부분을 추가합니다.";
...
Blockly.Msg.CONTROLS_WHILEUNTIL_OPERATOR_UNTIL = "while not";
