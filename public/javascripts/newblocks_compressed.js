	...
	onchange : function (a) {
		if (this.workspace &&
			...
			if (a.type == Blockly.Events.CREATE && -1 != a.ids.indexOf(this.id)) {
				...
				a.type == Blockly.Events.DELETE && (b = this.getProcedureCall(), b = Blockly.Procedures.getDefinition(b, this.workspace), b || (Blockly.Events.setGroup(a.group), this.dispose(!0, !1), Blockly.Events.setGroup(!1)))
	},
	customContextMenu : function (a) {
		var b = {
			enabled : !0
	...
	init : function () {
		...
		this.setTooltip(function () {
			...
			if ("FROM_START" == b || "FROM_END" == b)
				c += "  " + ("FROM_START" == b ? Blockly.Msg.LISTS_INDEX_FROM_START_TOOLTIP : Blockly.Msg.LISTS_INDEX_FROM_END_TOOLTIP).replace("%1", a.workspace.options.oneBasedIndex ? "#1" : "#0");
			return c
		})
	},
	mutationToDom : function () {
...
Blockly.Blocks.controls_if = {
	...
	compose : function (a) {
		...
		for (b = 1; b <= this.elseifCount_; b++)
			Blockly.Mutator.reconnect(a[b], this,
...
Blockly.Blocks.waiting_fishbread = {
	init : function () {
    this.appendDummyInput()
        .appendField("waiting()");
...
Blockly.Blocks.pour_add_fishbread = {
	init : function () {
    this.appendDummyInput()
        .appendField("pour_add()");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(230);
    this.setTooltip('');
...
Blockly.Blocks.close_fishbread = {
	init : function () {
    this.appendDummyInput()
        .appendField("close()");
    this.setPreviousStatement(true, null);
...
Blockly.Blocks.rotate_right_fishbread = {
	init : function () {
    this.appendDummyInput()
        .appendField("rotate_right()");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(230);
    this.setTooltip('');
...
Blockly.Blocks.rotate_left_fishbread = {
	init : function () {
    this.appendDummyInput()
...
Blockly.Blocks.complete_fishbread = {
	init : function () {
    this.appendDummyInput()
...
Blockly.Blocks.burnt_fishbread = {
	init : function () {
    this.appendDummyInput()
        .appendField("burnt()");
    this.setPreviousStatement(true, null);
...
Blockly.Blocks.less_ripe_fishbread = {
	init : function () {
    this.appendDummyInput()
        .appendField("less_ripe()");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(230);
    this.setTooltip('');
...
Blockly.Blocks.add_blueberry_fishbread = {
	init : function () {
    this.appendDummyInput()
        .appendField("add_blueberry()");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(230);
    this.setTooltip('');
...
Blockly.Blocks.add_greentea_fishbread = {
	init : function () {
    this.appendDummyInput()
        .appendField("add_greentea()");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(230);
    this.setTooltip('');
...
Blockly.Blocks.add_strawberry_fishbread = {
	init : function () {
    this.appendDummyInput()
        .appendField("add_strawberry()");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(230);
    this.setTooltip('');
...
Blockly.Blocks.repour_fishbread = {
	init : function () {
    this.appendDummyInput()
        .appendField("repour()");
    this.setPreviousStatement(true, null);
...
Blockly.Blocks.repour_blueberry_fishbread = {
	init : function () {
    this.appendDummyInput()
        .appendField("repour_blueberry()");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(230);
    this.setTooltip('');
...
Blockly.Blocks.repour_strawberry_fishbread = {
	init : function () {
    this.appendDummyInput()
        .appendField("repour_strawberry()");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(230);
    this.setTooltip('');
...
Blockly.Blocks.repour_greentea_fishbread = {
	init : function () {
    this.appendDummyInput()
        .appendField("repour_greentea()");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(230);
    this.setTooltip('');
...
Blockly.Blocks.reclose_fishbread = {
	init : function () {
    this.appendDummyInput()
        .appendField("reclose()");
    this.setPreviousStatement(true, null);
